  ...
  return (
    <VStack align='stretch' spacing={8} w='100%' maxW='lg'>
      <VStack textAlign='center'>
        <Heading fontSize={{ base: '2xl', md: '4xl' }}>{t('Sign in to your account')}</Heading>
      ...
      <Box rounded='lg' bg={useColorModeValue('white', 'gray.700')} boxShadow='lg' p={{ base: 6, md: 8 }}>
        <VStack
          as='form'
          spacing={4}
          onSubmit={e => {
          ...
          <TextInput id='username' value={username} onChange={e => setUsername(e.currentTarget.value)}>
            {t('Username')}
          </TextInput>
          <TextInput id='password' type='password' value={password} onChange={e => setPassword(e.currentTarget.value)}>
            {t('Password')}
          </TextInput>
          <VStack w='100%' spacing={10}>
            <Stack w='100%' direction={{ base: 'column', sm: 'row' }} align='start' justify='space-between'>
