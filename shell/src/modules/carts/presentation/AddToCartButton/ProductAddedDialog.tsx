...
import { useProductAddedDialogStore } from './useProductAddedDialogStore'
        ...
        <AlertDialogContent>
          ...
          <AlertDialogBody>
            <VStack align='stretch'>
              <Text>{t('Wonderful! You have already added a new product to your cart.')}</Text>
              <Text fontSize='xs' color={secondaryColor}>
                {t("(because this app uses a fake API, the request will be mocked and won't affect the app's data)")}
              </Text>
            </VStack>
          </AlertDialogBody>
          <AlertDialogFooter>
