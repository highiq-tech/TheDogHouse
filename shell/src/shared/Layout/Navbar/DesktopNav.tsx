...
export const DesktopNav = () => {
  ...
  const linkColor = useColorModeValue('gainsboro', 'gainsboro')
  const popoverContentBgColor = useColorModeValue('white', 'gray.800')
  const brandColor = useColorModeValue('white', 'white')
  ...
  return (
    <ChLink
      ...
      <Stack direction='row' align='center'>
        <Box>
          <Text transition='all .3s ease' _groupHover={{ color: brandColor }} fontWeight='bold'>
            {label}
          </Text>
